siginvest.grid.Partners = function (config) {
    config = config || {};
    if (!config.id) {
        config.id = 'siginvest-grid-partners';
    }
    Ext.applyIf(config, {
    ...
    siginvest.grid.Partners.superclass.constructor.call(this, config);
...
Ext.extend(siginvest.grid.Partners, MODx.grid.Grid, {
    windows: {},
...
Ext.reg('siginvest-grid-partners', siginvest.grid.Partners);